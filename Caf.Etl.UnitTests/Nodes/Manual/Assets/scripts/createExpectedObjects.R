...
df <- read_csv("L1_Aggregated2013-2016_20180625_slim.csv")

# print HandHarvestYieldV1 code
handHarvestYieldV1Code <- paste("public ", "dt", " ", names(df), " { get; set; }", sep = "")
writeLines(handHarvestYieldV1Code, "scripts/handHarvestYieldV1Code.txt")
